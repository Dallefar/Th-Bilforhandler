...
function notifyIngenPlads()
	lib.notify({
		id = "biler4",
		title = "Der ikke plads til dette køretøj",
		position = "right-top",
		style = Config.Notify.Style,
		icon = "car",
		iconColor = "#C53030",
...
function notifyVehicleSoldToFactory(plate, finalPrice)
	lib.notify({
		id = "biler8",
		title = plate .. " solgt til " .. HT.Math.Round(finalPrice) .. " DKK",
		position = "right-top",
		style = Config.Notify.Style,
		icon = "circle-check",
		iconColor = "#0afc12",
...
function notifymoney(money)
	lib.notify({
		id = "biler12",
		title = money .. " kr. blev sat i bilforhandler kontoen.",
		position = "right-top",
		style = Config.Notify.Style,
		icon = "circle-check",
		iconColor = "#0afc12",
...
function notifyremovemoney(money)
	lib.notify({
		id = "biler12",
		title = money .. " kr. blev taget af bilforhandler kontoen.",
		position = "right-top",
		style = Config.Notify.Style,
		icon = "circle-check",
		iconColor = "#0afc12",
