        ...
        if next(data) == nil then
          ...
          for _, v in pairs(data) do
              ...
              table.insert(carsStock, {
                  ...
                  icon = 'car-side',
                  onSelect = function()
                      sellVehicleToPlayer(bilModel, nummerPlade, firstName, lastName, playerId, price, seller,veh_type)
                  end
              })
          end
          lib.registerContext({
...
--                TriggerServerEvent('th-bilforhandler:removePlayerMoney', playerId, price)
                TriggerServerEvent('th-bilforhandler:targetId', model, plate, firstName, lastName, playerId, vehiclePrice, seller, veh_type)
            else
...
RegisterNetEvent('th-bilforhandler:targetIdClient', function(model, plate, firstName, lastName, playerId, vehiclePrice, seller, veh_type)
    ...
    if alert == 'confirm' then
        spawnVehicle(model, plate, playerId, vehiclePrice, veh_type)
